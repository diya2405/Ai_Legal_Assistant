...
import { 
  ...
  BookOpen, AlertTriangle, Layers, FileCheck, Landmark, Info
} from 'lucide-react';
  ...
  return (
    <div className="app-wrapper">
      ...
      <main className="main-container">
        ...
        {/* ==================== SEARCH / INTAKE PAGE (Initial State) ==================== */}
        {!kbEntry ? (
            ...
            <div className="glass-card intake-card">
              <div className="intake-header">
                <h2 className="section-heading">
                  <Edit3 size={20} className="icon-accent-blue" />
              ...
              <div>
                ...
                <div className="prompt-starters">
                  {SAMPLE_STARTERS.map((starter, i) => (
                    ...
                    >
                      <ChevronRight size={12} className="icon-accent-blue" />
                      {starter.label}
                    </button>
                  ))}
                </div>
        ...
        /* ==================== INNER PAGE RESULTS WORKSPACE (After Clicking Analyze) ==================== */
          <div className="results-workspace">
            
            {/* Top Workspace Action & Summary Header */}
            <div className="workspace-header glass-card">
              <div className="header-left">
                <button className="btn-back" onClick={handleResetSearch}>
                  <ArrowLeft size={16} />
                  {lang === 'hi' ? 'नया मामला / पिछला' : 'New Analysis'}
                </button>
                
                <div className="case-title-meta">
                  <h1 className="case-heading">
                    {classification?.domain.toUpperCase()} • {classification?.issue_type.replace(/_/g, ' ').toUpperCase()}
                  </h1>
                  <div className="meta-pills">
                    ...
                    <span className="pill pill-emerald">
                      <ShieldCheck size={12} /> 100% Citation Guard Verified
                    </span>
              ...
              <div className="header-right">
                ...
                >
                  <BookOpen size={14} />
                  {showOriginalIntake ? 'Hide Facts' : 'View Input Facts'}
                </button>
              </div>
            </div>

            {/* Collapsible Original Case Facts Banner */}
            {showOriginalIntake && (
              <div className="glass-card original-facts-box animate-fadeIn">
                <div className="facts-box-title">
                  ...
                  Submitted Intake Facts:
                </div>
                <p className="facts-box-text">"{intakeData?.intake_id ? inputText : 'N/A'}"</p>
              </div>
            )}

            {/* 4 Metric Quick-Stat Cards Banner */}
            <div className="stats-grid">
              <div className="stat-card glass-card border-blue">
                <div className="stat-label">Applicable Act</div>
                <div className="stat-value text-blue">{kbEntry.act_name}</div>
                <div className="stat-subtext">Statutory Authority</div>
              </div>

              <div className="stat-card glass-card border-pink">
            ...
            <div className="nav-tabs-bar glass-card">
              ...
              >
                <Sparkles size={18} />
                {lang === 'hi' ? '1. अधिकार एवं धाराएं' : '1. Legal Rights & Statutes'}
              </button>
              ...
              <div className="tab-content-grid animate-fadeIn">
                ...
                <div className="glass-card panel-card hero-explanation-panel">
                  ...
                  <div className="panel-footer-meta">
                    <span>Source: Verified Deterministic Knowledge Base</span>
                    <span>Provider: <strong className="text-emerald">{explanationData?.provider_used || 'KB Seed'}</strong></span>
                  </div>
                </div>

                {/* Statutory Statute & Forum Breakdown Card */}
                <div className="glass-card panel-card">
                  <div className="panel-header">
                    <div className="panel-title">
                      <Scale size={22} className="icon-accent-emerald" />
                  ...
                  <div className="details-list">
                    <div className="detail-item">
                      ...
                      <div className="detail-value text-blue">{kbEntry.act_name}</div>
                    </div>
                    ...
                    <div className="detail-item">
                      <div className="detail-label">Appropriate Forum for Filing</div>
                      <div className="detail-value text-amber">
                  ...
                  <div className="limitation-alert-box">
                    ...
                    <div>
                      <strong>Important Limitation Notice:</strong> You must issue formal notice or file a claim within <strong>{kbEntry.limitation_period}</strong> from the date of cause of action. Delay may forfeit your legal remedy.
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="glass-card panel-card">
                  <div className="panel-header">
                    <div className="panel-title">
                      ...
                      {lang === 'hi' ? 'कानूनी नोटिस की जानकारी दर्ज करें' : 'Configure Legal Notice'}
                    </div>
                    ...
                    <div className="form-group">
                      ...
                      <div className="tone-grid">
                        ...
                        >
                          ...
                          <div className="tone-desc">Firm but diplomatic request before taking legal steps</div>
                        </button>
                        <button 
                          type="button"
                ...
                <div className="glass-card panel-card pdf-preview-card">
                  <div className="panel-header">
                    <div className="panel-title">
                      ...
                      Document Draft Blueprint
                    </div>
                    <span className="pill pill-blue">Format: PDF (A4)</span>
                  </div>

                  <div className="pdf-sheet">
                    <div className="pdf-header">FORMAL LEGAL NOTICE</div>
                    ...
                    <div className="pdf-body-preview">
                      <p><strong>SUBJECT:</strong> STATUTORY LEGAL DEMAND UNDER {kbEntry.act_name.toUpperCase()} ({kbEntry.section_number})</p>
                      <br />
                      <p>Sir/Madam,</p>
                      ...
                      <br />
                      <p><strong>RELIEF SOUGHT:</strong> Immediate compliance within 15 days, failing which formal legal proceedings will be instituted in {kbEntry.remedy_forum}.</p>
                    </div>
                    <div className="pdf-watermark">PREVIEW DRAFT</div>
                  </div>
                </div>
            ...
            {activeTab === 'chat' && (
              <div className="glass-card panel-card chat-workspace-card animate-fadeIn">
                <div className="panel-header">
                  <div className="panel-title">
                    <MessageSquare size={22} className="icon-accent-amber" />
                    {lang === 'hi' ? 'कानूनी धारा Q&A चैट' : 'Grounded Statutory Q&A Chat'}
                  </div>
                ...
                <div className="chat-messages-container">
                  {chatMessages.length === 0 && (
                    <div className="chat-empty-state">
                      ...
                      <p className="empty-title">Ask follow-up questions about {kbEntry.act_name}</p>
                      <p className="empty-sub">Answers are grounded in statutory codes and legal precedents.</p>
                    </div>
                  )}
                  ...
                  {chatLoading && (
                    <div className="chat-bubble-row assistant">
                      ...
                      <div className="chat-bubble-content loading-bubble">
                        <RefreshCw size={14} className="animate-spin" /> Grounding response in law chunks...
                      </div>
                    </div>
                  )}
                </div>
                    ...
                    {entities.map((ent, idx) => (
                      <div key={idx} className="entity-card glass-card">
                        ...
                        <div className="entity-status">
                          <CheckCircle2 size={12} className="icon-emerald" /> Extracted Fact
                        </div>
                      </div>
                    ))}
                  </div>
      ...
      <footer className="app-footer">
        <div className="footer-content">
          <strong className="text-amber">Mandatory Legal Disclaimer:</strong> {MANDATORY_DISCLAIMER}
        </div>
      </footer>
